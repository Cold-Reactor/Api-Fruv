...
namespace api_SIF.Controllers
{
    ...
    public class Checadas2Controller : ControllerBase
    {
        ...
        public Checadas2Controller(RHDBContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Checadas2
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Checadas2>>> GetChecadas2s()
        {
            return await _context.Checadas2s.ToListAsync();
        }
        ...
        {
            var checadas2 = await _context.Checadas2s.FindAsync(id);
        ...
        {
            _context.Checadas2s.Add(checadas2);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteChecadas2(int id)
        {
            ...
            _context.Checadas2s.Remove(checadas2);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Checadas2s.Any(e => e.Id == id);
        }
    }
}
